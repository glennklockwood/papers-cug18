...
The first six connectors listed (CraySdb through Slurm) are either pre-installed on Cray XC and ClusterStor systems or are widely deployed, open-source tools.
The latter three connectors (\mbox{CollectdEs}, \mbox{NerscIsdct}, and \mbox{NerscJobsDb}) rely on third-party infrastructure and/or use schemata specific to non-standard tools.
